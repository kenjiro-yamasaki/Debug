    ...
    public class AppenderTests
    {
        ...
        public class MaxLevel
        {
            ...
            public void Info_Info以下を出力する()
            {
                ...
                SubstituteExtensions.Received(appender, (int)1).Log(nameof(SoftCube.Logging.Level.Trace));
                appender.Received(1).Log(nameof(SoftCube.Logging.Level.Debug));
                appender.Received(1).Log(nameof(SoftCube.Logging.Level.Info));
                appender.DidNotReceive().Log(nameof(SoftCube.Logging.Level.Warning));
                appender.DidNotReceive().Log(nameof(SoftCube.Logging.Level.Error));
                appender.DidNotReceive().Log(nameof(SoftCube.Logging.Level.Fatal));
            }
